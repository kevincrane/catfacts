...
DATABASES = {
    'default': {
        ...
        'USER': 'catfacts',                      # Not used with sqlite3.
...
SECRET_KEY = 'w^irl%r@*=bn(e+@w9nf$i%4@4e4-ifs%f$-!j1fc+cb^0wqx4'
...
ROOT_URLCONF = 'catfactssite.urls'
...
# Load Dev properties if applicable
try:
